...
function path(obj) {
  return path_helper(obj, "");
}

function path_helper(obj, curr_path) {
  // is a dictionary
  if (typeof obj === "object" && !Array.isArray(obj)) {
    for (var key in obj) {
      const new_key = curr_path + key + "/";
      obj[new_key] = path_helper(obj[key], new_key);
      delete obj[key];
    }
  }
  return obj;
...
//   return path_helper(obj, "")
//
// def path_helper(obj, curr_path):
//   if not isinstance(obj, dict):
//     return obj
//   for key in obj.keys():
//     new_key = curr_path + key + "/"
//     obj[new_key] = path_helper(obj[key], new_key)
//     del obj[key]
//   return obj
//
